...
6. テキスト内の数値: Item 1, Item 2を選択してドラッグ → Item 3, Item 4...
7. 複数の数値: Test-2-A-5, Test-2-A-6を選択してドラッグ → Test-2-A-7, Test-2-A-8...
8. ゼロパディング: File001, File002を選択してドラッグ → File003, File004...
9. 複雑なケース: R-B-Web-013-001, R-B-Web-013-002を選択してドラッグ → R-B-Web-013-003, R-B-Web-013-004...
10. ゼロパディング桁上がり: File099を選択してドラッグ → File100, File101...
11. コピー: テキストを選択してドラッグ → 同じテキストが繰り返される
